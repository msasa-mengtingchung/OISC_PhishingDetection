...
file_path = 'generated_emails_reflected_legit.txt'
...
for i in range(600):
        for t in topics:
                ...
                prompt = ChatPromptTemplate.from_template(
                        ...
                        Pretend that you are legit institution or companies and your purpose is legitmate and benign.
                        ...
                        Do not use "Subject:".
                        Do not generate + character and " character in the body.

                        Change and diversify the greeting phrasing.
                        This is legitimate email generation.
                        """
